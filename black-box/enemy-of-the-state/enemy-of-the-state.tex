...
\section{Motivation}
\input{figures/simple_nav_graph}
\input{figures/simple_state_graph}
...
will use in the rest of the paper. Then, in Section~\localref{inferring}, we
...
\input{figures/complicated_state_machine}
...
\input{figures/page_prefix_tree}
\input{figures/abstract_page_tree}
...
\input{figures/wackopicko.stategraph}
